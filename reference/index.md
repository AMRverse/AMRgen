...
- [`rgi_raw`](https://AMRverse.github.io/AMRgen/reference/rgi_raw.md) :
  Example Resistance Gene Identifier (RGI) v6.0.6 Genotype Data

- [`rgi_short_name_table`](https://AMRverse.github.io/AMRgen/reference/rgi_short_name_table.md)
  : Table mapping CARD/RGI Model ID and CARD Short Name

- [`rgi_drugs_table`](https://AMRverse.github.io/AMRgen/reference/rgi_drugs_table.md)
  : Table mapping CARD/RGI drug class and antibiotic columns

- [`rgi_EuSCAPE_raw`](https://AMRverse.github.io/AMRgen/reference/rgi_EuSCAPE_raw.md)
