...
#> $drugs_with_pheno
#> # A tibble: 2 × 8
#>   drug_agent     n drug_class      antibiotic_name spp_pheno    disk   mic  none
#>   <ab>       <int> <chr>           <chr>           <chr>       <int> <int> <int>
#> 1 AMK           84 Aminoglycosides Amikacin        Staphyloco…     3    11    70
#> 2 DOX          134 Tetracyclines   Doxycycline     Staphyloco…    NA    47    87
#> 
#> $geno_hits
#> # A tibble: 7 × 6
...
#> $geno_markers
#> # A tibble: 12 × 5
#>    marker                 drug_agent antibiotic   drug_class          n
#>    <chr>                  <ab>       <chr>        <chr>           <int>
