...
converter](https://converter.amrgen.org/) web app which uses AMRgen
functions to export submission-ready files suitable for depositing with
NCBI or ENA (via EBI AMR portal) as BioSample data. This is a
point-and-click Shiny web app that does not require you to install or
use R.
...
analyse genotypic and phenotypic data together, see
...
- [Large-scale surveillance data for *Neisseria
  gonorrhoeae*](http://amrgen.org/articles/NeisseriaGonoExamples.md)
...
- [Exploring *catB3* deletion variants and impact on chloramphenicol
  ...
  phenotypes
- [Analysing meropenem resistance in *Klebsiella
