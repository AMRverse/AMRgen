...
usethis::use_data(staph_pheno_ncbi, internal = FALSE, overwrite = TRUE)
...
usethis::use_data(staph_pheno_ncbi_raw, internal = FALSE, overwrite = TRUE)
...
usethis::use_data(staph_pheno_ncbi_cloud_raw, internal = FALSE, overwrite = TRUE)
...
staph_geno_ncbi_cloud_raw <- staph_geno_ncbi_cloud_raw %>% filter(biosample_acc %in% staph_pheno_ncbi_cloud_raw$BioSample)
...
usethis::use_data(staph_pheno_ebi, internal = FALSE, overwrite = TRUE)
