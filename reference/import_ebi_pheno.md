...
(<https://www.ebi.ac.uk/amr/data/?view=experiments>) Data downloaded
...
- source:
  ...
  (optional) A single string to record as the source of these data
...
names, MIC or disk measures) into suitable classes using the AMR
package. It optionally can use the AMR package to interpret MIC/disk
zone measures into susceptibility phenotypes (SIR) based on EUCAST or
CLSI guidelines (human breakpoints and/or ECOFF).
